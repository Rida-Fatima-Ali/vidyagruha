    ...
    >
      ...
      <div
        style={{
          position:  "absolute",
          inset:     0,
          background:"radial-gradient(ellipse 50% 50% at 50% 50%, rgba(5,13,26,0.0) 0%, rgba(5,13,26,0.85) 100%)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        >
          Built for modern campuses — simplifying academic workflows end to end.
        </p>
        <p
          style={{
        ...
        >
          Designed with clarity, built with purpose, loved by institutions.
        </p>
      </motion.div>
    </section>
  );
